...
public class QBoardData extends EntityPathBase<BoardData> {
    ...
    private static final long serialVersionUID = 1024319575L;
    ...
    public final org.ssum.member.entities.QMember member;
    ...
    public QBoardData(Class<? extends BoardData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new org.ssum.member.entities.QMember(forProperty("member")) : null;
    }
